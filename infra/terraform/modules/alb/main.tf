...
# Target group for the FastAPI backend (port 8000)
...
# Port 80: Web (default) with API path rules
...
# Port 8000: direct API access (useful for debugging / CI)
...
# Allow ALB to reach ECS containers
